...
from ayallm.models.chat import Chat, ChatParameters

from llama_cpp import Llama
from ayallm.utils.stream import get_prompt
...
async def create_new_chat(
    ...
    init_prompt: str = "Your name is Aya ! You are a Personal Intelligent Assistant developed by Weloobe. Carefully heed the user's instructions. Respond using Markdown.",
    n_threads: int = 4,
):
    try:
        client = Llama(
